...
public class ActivityRestaurant2 extends AppCompatActivity {

    String numero_ristorante = "+390761924279";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantID.setText("Il piccolo Mondo");
        orarioID.setText("08–15:30");
        immagine_ristorante.setImageResource(R.drawable.ristorante2);
        ...
        rec1= new Recensione((float) 4.5,"Piergiorgio","Si mangiano cose");
        rec2= new Recensione((float) 3.2,"Martina","Si possono portare anche i cani");
        rec3= new Recensione((float) 4.1,"Marco Harambe","Fanno un' ottima bistecca");
        rec4= new Recensione((float) 1.0,"Francesco Cose","Per me è no");
