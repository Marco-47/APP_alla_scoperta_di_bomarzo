...
public class ActivityRestaurant3 extends AppCompatActivity {

    String numero_ristorante = "+390761924279";
    String indirizzo_web = "https://www.facebook.com/Agriristoro-Taverna-Degli-Orsini-1067188040006670";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantID.setText("Agriristoro Taverna degli Orsini");
        orarioID.setText("Assente");
        immagine_ristorante.setImageResource(R.drawable.ristorante3);
        ...
        rec1= new Recensione((float) 4.5,"Orsetto","beh che dire, buono il cibo e bello l' arredamento");
