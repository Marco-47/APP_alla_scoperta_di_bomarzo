...
public class ActivityRestaurant4 extends AppCompatActivity {

    String numero_ristorante = "+390761924281";
    String indirizzo_web = "http://www.ristorante-il-quadrifoglio.ory.it/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantID.setText("Il Quadrifoglio");
        orarioID.setText("12:30–15 || 19:30–23");
        immagine_ristorante.setImageResource(R.drawable.ristorante4);
        ...
        rec1= new Recensione((float) 1.0,"Morte nera","Poca morte nei piatti");
